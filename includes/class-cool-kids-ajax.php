...
class Cool_Kids_Ajax {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_nopriv_signup_user', array( $this, 'signup_user' ) );
		add_action( 'wp_ajax_signup_user', array( $this, 'signup_user' ) );
	...
	public function signup_user() {
		...
		if ( is_wp_error( $response ) ) {
			wp_send_json_error( array( 'message' => 'Failed to generate character.' ) );
		}
		...
		if ( is_wp_error( $user_id ) ) {
			wp_send_json_error( array( 'message' => 'User registration failed.' ) );
		}
		...
		wp_send_json_success( array( 'message' => 'Sign up successful! you will be redirected to the login page' ) );
	}
	...
	public function login_user() {
		...
		wp_send_json_success( array( 'message' => 'Login successful! You will be redirected to your profile.' ) );
	}
}
