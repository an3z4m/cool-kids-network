...
if ( ! empty( $users ) ) {
	...
	echo '<table id="user-list-content">';
	...
	foreach ( $users as $user ) {
		...
		echo '<tr>';
		echo '<td data-label="Profile Image"><img src="' . $image_url . '" alt="Profile Image" style="border-radius: 50%; width: 70px; height: 70px;"></td>';
		echo '<td data-label="First Name">' . esc_html( $first_name ) . '</td>';
		echo '<td data-label="Last Name">' . esc_html( $last_name ) . '</td>';
		echo '<td data-label="Country">' . esc_html( $country ) . '</td>';
