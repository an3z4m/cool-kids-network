...
register_activation_hook(__FILE__, [$cool_kids_network, 'add_roles']);
// remove the custom roles and capabilities when the plugin is deactivated
register_deactivation_hook(__FILE__, [$cool_kids_network, 'remove_roles']);
// create the plugin pages when the plugin is activated
register_activation_hook(__FILE__, [$cool_kids_network, 'create_plugin_pages']);
